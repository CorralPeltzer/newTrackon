...
<div class="container">
    ...
    <p><b>WARNING: Don't put these URLs in your BitTorrent client, they won't work. You have to put the trackers
        returned by these URLs in the BitTorrent client.</b></p>

    <dl>
        <dt>GET <a href="/api/stable">https://newtrackon.com/api/stable</a></dt>
        <dd>Returns a two line delimited list announce URLs of trackers that have an uptime of equal or more than 95%.
        </dd>

        <dt>GET <a href="/api/70">https://newtrackon.com/api/:percentage</a></dt>
        <dd>Returns a two line delimited list announce URLs of trackers that have an uptime of equal or more than the
            given percentage.
        </dd>
    ...
    <dl>
        ...
        <dd>Body: "application/x-www-form-urlencoded" Content Type, with an URL encoded body with the only key as
            "new_trackers" and its value the trackers separated by any whitespace character.
        </dd>
