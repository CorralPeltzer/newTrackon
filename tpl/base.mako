...
<head>
    ...
    % if active == 'list':
        <script src="https://cdnjs.cloudflare.com/ajax/libs/clipboard.js/1.6.1/clipboard.min.js"
                integrity="sha256-El0fEiD3YOM7uIVZztyQzmbbPlgEj0oJVxRWziUh4UE=" crossorigin="anonymous"></script>
    % endif
    % if active == 'submitted':
        <script src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.18.1/moment.min.js"
                integrity="sha256-1hjUhpc44NwiNg8OwMu2QzJXhD8kcj+sJA3aCQZoUjg=" crossorigin="anonymous"></script>
    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse" id="navbar-main">
            <ul class="nav navbar-nav">
                ...
                % endif
                % if active == 'submitted':
                    <li class="active"><a href="/submitted"><i class="fa fa-plus" aria-hidden="true"></i> Submitted</a>
                    </li>
                % else:
                    <li><a href="/submitted"><i class="fa fa-plus" aria-hidden="true"></i> Submitted</a></li>
                % endif
                % if active == 'faq':
                    <li class="active"><a href="/faq"><i class="fa fa-question-circle" aria-hidden="true"></i> FAQ</a>
                    </li>
                % else:
                ...
                % endif
                % if active == 'raw':
                    <li class="active"><a href="/raw"><i class="fa fa-terminal" aria-hidden="true"></i> Raw data</a>
                    </li>
                % else:
                    <li><a href="/raw"><i class="fa fa-terminal" aria-hidden="true"></i> Raw data</a></li>
                % endif
                <li><a href="https://github.com/CorralPeltzer/newTrackon"><i class="fa fa-github"
